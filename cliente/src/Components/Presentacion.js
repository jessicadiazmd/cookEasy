...
function Presentacion() {
  return (
    <Row className="inicio top">
      <Col s={8} sm={8} md={6} lg={5} xl={5} className="textoInicio">
        <p className="playfair">
          <span className="negro mayor">Encuentra</span>
          <br></br>
          <span className="rosa mayor">la receta perfecta</span>
          <br></br>
          <span className="negro mayor">para cada momento</span>
        </p>
        <p className="negro ">
